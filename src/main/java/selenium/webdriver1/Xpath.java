...
public class Xpath {
	...
	public void TC_02_Register_Invalid_Email() {
		...
		driver.findElement(By.id("txtEmail")).sendKeys("thang nguyen");
		driver.findElement(By.id("txtCEmail")).sendKeys("thang nguyen");
		driver.findElement(By.id("txtPassword")).sendKeys("123456");
		driver.findElement(By.id("txtCPassword")).sendKeys("123456");
		driver.findElement(By.id("txtPhone")).sendKeys("0915810375");
		driver.findElement(By.xpath("//form[@id='frmLogin']//button[text()='ĐĂNG KÝ'] ")).click();
		sleepInSecond(2);
	...
	public void TC_03_Register_Incorrect_Email() {
		...
		driver.findElement(By.id("txtCEmail")).sendKeys("nguyenthithang01@gmail@gmail.com");
		driver.findElement(By.id("txtPassword")).sendKeys("123456");
		driver.findElement(By.id("txtCPassword")).sendKeys("123456");
